...
- experience_years — חשב מסך שנות העבודה בפועל, לא מגיל ולא משנות לימודים. תפקיד שכתוב עליו
  במפורש שהוא פרקטיקום / התמחות / סטאז' במסגרת הלימודים אינו ניסיון תעסוקתי; אם זה כל מה שיש
  לה — "ללא ניסיון".
